...
def guardar():
    ...
    for i in range(v):
        ...
        if nua_inicial == read_alumno.nua:
            print(
                'NUA ya registrado, por favor vuelva a escoger la opcion 1-Guardar estudiante  del Menu e ingrese otro NUA diferente')
            switch()
        else:
            continue
    nua = nua_inicial
...
def actualizar():
    ...
    for i in range(v):
        ...
        if nua_inicial == read_alumno.nua:
            ...
            print(
                'NUA no encontrado, por favor vuelva a escoger la opcion 3-Actualizar estudiante  del Menu e ingrese un NUA registrado')
            switch()
        else:
            continue
    file4.close()
    ...
    for i in range(v):
        ...
        if nua_inicial == read_alumno.nua:
            ...
            file7.close()
    file5.close()
    file8 = open('students.db', 'rb')
    file9 = open('students.db', 'ab+')
    if file8.closed and file9.closed:
